...
local mainFrame = Window.MainFrame or Window
...
UserInputService.InputBegan:Connect(function(input, processed)
    ...
    if input.UserInputType == Enum.UserInputType.MouseButton1 or input.UserInputType == Enum.UserInputType.Touch then
        ...
        local relativePos = inputPos - mainFrame.AbsolutePosition
        if relativePos.Y <= DRAG_AREA_HEIGHT and relativePos.X <= (mainFrame.AbsoluteSize.X - 40) then
            isDragging = true
