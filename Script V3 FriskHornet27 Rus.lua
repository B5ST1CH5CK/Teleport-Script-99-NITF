...
local Window = Library.CreateLib("Телепорт | 99 НВЛ FriskHornet27", "RJTheme3")
...
Section:NewButton("Безопасная Зона", "", function()
  game.Workspace.FriskHornet27.HumanoidRootPart.CFrame = 13.3217888, 3.97840118, 9.94304371
end)
