...
Section:NewButton("SafeZone", "Teleports you to the fire, no matter where you are", function()
    game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame = CFrame.new(13.3217888, 3.97840118, 9.94304371)
end)
local Tab = Window:NewTab("Lost Child")
local Section = Tab:NewSection("Teleport you to Lost Child")
Section:NewButton("Lost Child 1", "Teleports you to Lost Child 1, if you want to loot the contents of the chest, but first you need to find a cave with a lost child" ,function()
  game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame = game.workspace.Character['Lost Child'].HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 2", "Teleports you to Lost Child 2, if you want to loot the contents of the chest, but first you need to find a cave with a lost child", function()
  game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame = game.workspace.Character['Lost Child2'].HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 3", "Teleports you to Lost Child 3, if you want to loot the contents of the chest, but first you need to find a cave with a lost child", function()
  game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame = game.workspace.Character['Lost Child3'].HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 4", "Teleports you to Lost Child 4, if you want to loot the contents of the chest, but first you need to find a cave with a lost child", function()
...
Section:NewButton("Lost Child 1", "Teleports Lost Child 1 to you, if you won't to loot the contents of the chest, but first you need to find a cave with a lost child", function()
  game.workspace.Character['Lost Child'].HumanoidRootPart.CFrame = game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 2", "Teleports Lost Child 2 to you, if you won't to loot the contents of the chest, but first you need to find a cave with a lost child", function()
  game.workspace.Character['Lost Child2'].HumanoidRootPart.CFrame = game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 3", "Teleports Lost Child 3 to you, if you won't to loot the contents of the chest, but first you need to find a cave with a lost child", function()
  game.workspace.Character['Lost Child3'].HumanoidRootPart.CFrame = game.Workspace.Freez_Tiime.HumanoidRootPart.CFrame
end)
Section:NewButton("Lost Child 4", "Teleports Lost Child 4 to you, if you won't to loot the contents of the chest, but first you need to find a cave with a lost child", function()
